...
There are people in the RDF community who want SWT to be more digestible for 'the average IT developer'. This should not be translated into ad hoc and standalone usage of the W3C standards, deviating from the original goals of the Semantic Web. Semantic interoperability and machine reasoning should at all time be preserved.
